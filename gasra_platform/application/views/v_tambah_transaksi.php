...
<head>
    ...
    <title>GASRA | New Transaction</title>
...
<div class="content-wrapper">
    <div class="form-card animate__animated animate__zoomIn" style="animation-duration: 0.6s;">
        <div class="form-title">
            <i class="fas fa-plus-circle"></i> Create New Operational Log
        </div>
        
        <form action="<?php echo base_url('transaksi/aksi_tambah'); ?>" method="post">
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-6">
                    ...
                    <select name="customer" class="form-select" required>
                        ...
                        <?php foreach($customers as $c): ?>
                            <option value="<?php echo $c->nama; ?>">
                                <?php echo $c->nama; ?> (Rate: Rp <?php echo number_format($c->rupiah_pjbg, 0, ',', '.'); ?>)
                            </option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="col-md-6">
                    ...
                    <select name="craddle" class="form-select" required>
                        <option value="">-- Select Cradle --</option>
                        <?php foreach($trailers as $t): ?>
                            <option value="<?php echo $t->nama; ?>">
                                <?php echo $t->nama; ?> (LWC: <?php echo $t->lwc; ?>)
                            </option>
                        <?php endforeach; ?>
                    </select>
                </div>
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-6">
                    <label class="form-label">Departure Date (Kirim)</label>
                    <input type="datetime-local" name="tgl_kirim" class="form-control" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label">Arrival Date (Ambil)</label>
                    <input type="datetime-local" name="tgl_ambil" class="form-control" required>
                </div>
            </div>
            ...
            <div class="row g-4 mb-5">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <input type="number" step="0.01" name="p_awal" class="form-control" placeholder="0.00" required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <input type="number" step="0.01" name="p_akhir" class="form-control" placeholder="0.00" required>
                        <span class="input-group-text">BAR</span>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center pt-4 border-top">
                <a href="<?php echo base_url('laporan'); ?>" class="btn-cancel">
